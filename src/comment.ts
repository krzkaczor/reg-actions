...
export const createCommentWithTarget = ({
  ...
  const tableRows = [
    result.newItems.length ? `| Added    | ${result.newItems.length}     |` : undefined,
    result.deletedItems.length ? `| Removed  | ${result.deletedItems.length} |` : undefined,
  ].filter(Boolean);
...
<sup><sub>This report was generated by comparing [${currentHashShort}](https://github.com/${owner}/${reponame}/commit/${currentHash}) with [${targetHashShort}](https://github.com/${owner}/${reponame}/commit/${targetHash}).[Compare](https://github.com/${owner}/${reponame}/compare/${targetHashShort}..${currentHashShort}).</sub></sup>`;
